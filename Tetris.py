...
def drawSquare(x,y,colour):
    if colour==1:
        win.blit(cyanBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==2:
        win.blit(blueBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==3:
        win.blit(greenBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==4:
        win.blit(orangeBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==5:
        win.blit(purpleBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==6:
        win.blit(redBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
    elif colour==7:
        win.blit(yellowBlock,(x*25+drawBoundsX[0]+1,y*25+drawBoundsY[0]+1))
...
def drawNext():
    block1=nextSequence[0]
    block2=nextSequence[0]
    block3=nextSequence[0]
    ...
    if nextSequence[0][0]==1:
        win.blit(Tetrad1,(310,80))
    elif nextSequence[0][0]==2:
        win.blit(Tetrad2,(310,80))
    elif nextSequence[0][0]==3:
        win.blit(Tetrad3,(310,80))
    elif nextSequence[0][0]==4:
        win.blit(Tetrad4,(310,80))
    elif nextSequence[0][0]==5:
        win.blit(Tetrad5,(310,80))
    elif nextSequence[0][0]==6:
        win.blit(Tetrad6,(310,80))
    elif nextSequence[0][0]==7:
        win.blit(Tetrad7,(310,80))
    if nextSequence[1][0]==1:
        win.blit(Tetrad1,(310,150))
    elif nextSequence[1][0]==2:
        win.blit(Tetrad2,(310,150))
    elif nextSequence[1][0]==3:
        win.blit(Tetrad3,(310,150))
    elif nextSequence[1][0]==4:
        win.blit(Tetrad4,(310,150))
    elif nextSequence[1][0]==5:
        win.blit(Tetrad5,(310,150))
    elif nextSequence[1][0]==6:
        win.blit(Tetrad6,(310,150))
    elif nextSequence[1][0]==7:
        win.blit(Tetrad7,(310,150))
    if nextSequence[2][0]==1:
        win.blit(Tetrad1,(310,230))
    elif nextSequence[2][0]==2:
        win.blit(Tetrad2,(310,230))
    elif nextSequence[2][0]==3:
        win.blit(Tetrad3,(310,230))
    elif nextSequence[2][0]==4:
        win.blit(Tetrad4,(310,230))
    elif nextSequence[2][0]==5:
        win.blit(Tetrad5,(310,230))
    elif nextSequence[2][0]==6:
        win.blit(Tetrad6,(310,230))
    elif nextSequence[2][0]==7:
        win.blit(Tetrad7,(310,230))
...
def drawHold():
    ...
    if heldType==1:
        win.blit(Tetrad1,(310,420))
    elif heldType==2:
        win.blit(Tetrad2,(310,420))
    elif heldType==3:
        win.blit(Tetrad3,(310,420))
    elif heldType==4:
        win.blit(Tetrad4,(310,420))
    elif heldType==5:
        win.blit(Tetrad5,(310,420))
    elif heldType==6:
        win.blit(Tetrad6,(310,420))
    elif heldType==7:
        win.blit(Tetrad7,(310,420))
def drawScore():
